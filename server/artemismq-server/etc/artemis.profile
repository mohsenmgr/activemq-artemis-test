...
ARTEMIS_INSTANCE='/var/lib/my-broker'
ARTEMIS_DATA_DIR='/var/lib/my-broker/data'
ARTEMIS_ETC_DIR='/var/lib/my-broker/etc'
ARTEMIS_OOME_DUMP='/var/lib/my-broker/log/oom_dump.hprof'

# The logging config will need an URI
# this will be encoded in case you use spaces or special characters
# on your directory structure
ARTEMIS_INSTANCE_URI='file:/var/lib/my-broker/'
ARTEMIS_INSTANCE_ETC_URI='file:/var/lib/my-broker/etc/'

# Cluster Properties: Used to pass arguments to ActiveMQ Artemis which can be referenced in broker.xml
#ARTEMIS_CLUSTER_PROPS="-Dactivemq.remoting.default.port=61617 -Dactivemq.remoting.amqp.port=5673 -Dactivemq.remoting.stomp.port=61614 -Dactivemq.remoting.hornetq.port=5446 -Djavax.net.debug=ssl,handshake""
